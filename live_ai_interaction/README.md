...
- **Combined_Throughput_Plot.png** - Visualization of bitrate/throughput data across different test conditions
- **Meta_AI_Latency_CDF.png** - Cumulative Distribution Function plot of latency measurements
